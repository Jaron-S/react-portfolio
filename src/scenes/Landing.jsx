      ...
      <div className="z-30 basis-2/5 mt-12 md:mt-32">
        ...
        >
          <p className="text-6xl font-playfair z-10 text-center md:text-start">
            <span
              className="xs:relative xs:text-deep-blue xs:font-semibold z-20
                  ...
                  before:-top-[70px] before:z-[-1] right-6 bottom-1"
            >
              <span className="relative left-6 top-1">
                Jaron
              </span>
            </span>
            <span
          ...
          <p className="mt-10 mb-7 text-sm text-center md:text-start">
            Welcome! I am a full stack web developer with a passion for creating
            beautiful, functional, and user-friendly web applications. With a
            solid foundation in HTML, CSS, and JavaScript, as well as experience
            with React, Node.js, Express.js, MongoDB, and SQL, I am eager to
            take on new projects and continue growing my skills.
          </p>
        </motion.div>
